...
/// </summary>
public sealed class AsciiRelativeLetterFrequenciesSpeculativePlaintextScorer : ISpeculativePlaintextScorer, IPartitionedSpeculativePlaintextScorer
{
	public AsciiRelativeLetterFrequenciesSpeculativePlaintextScorer(RelativeCharacterFrequencies relativeFrequencies)
	{
	...
	public ISpeculativePlaintextScorer GetForPartition() => new AsciiLetterPartitionedScorer(_relativeFrequencies.Frequencies);


	private sealed class AsciiLetterPartitionedScorer : ISpeculativePlaintextScorer
	{
		public AsciiLetterPartitionedScorer(IReadOnlyDictionary<char, double> reference)
		{
		...
		public double Score(ReadOnlySpan<char> speculativePlaintext)
		{
			FrequencyAnalysis.AnalyzeAsciiLetters(speculativePlaintext, _buffer);
