...
public class NGramFrequenciesSpeculativePlaintextScorerTests
{
	...
	public void Score_TwoAscii()
	{
		...
		var scorer2 = new TwoGramAsciiLettersRelativeFrequenciesSpeculativePlaintextScorer(Languages.English.GetNGramFrequencies(2));
	...
	{
		var scorer = new TwoGramAsciiLettersRelativeFrequenciesSpeculativePlaintextScorer(Languages.English.GetNGramFrequencies(2)).GetForPartition();
